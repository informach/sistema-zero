...
export const PISTA_DA_META: Record<SceneId, readonly [PistaMeta, PistaMeta, PistaMeta]> = {
  ...
  frames: [['two-drawings'], ['movement', 'paused-one'], ['slow-shows-two']],
  'onion-skin': [['blind-move'], ['ghost-on'], ['even-step']],
  symmetry: [['one-side'], ['two-sides'], ['axis-decides']],
  ...
  spawn: [['every-frame'], ['every-frame', 'spaced'], ['spaced']],
  cleanup: [['invisible-stored'], ['invisible-stored'], ['removed']],
  'game-state': [['outside'], ['waiting', 'playing'], ['waiting', 'playing']],
  controls: [['missing-touch'], ['start-tap'], ['start-tap', 'start-key']],
  restart: [['ended', 'screen-only'], ['restarted'], ['screen-only', 'restarted']],
  hitbox: [['contact'], ['area-contrast'], ['area-contrast']],
  score: [
    ['score-idle-wrong'],
    ['score-start', 'score-playing', 'score-end'],
    ['score-idle-wrong', 'score-start', 'score-playing', 'score-end'],
  ],
