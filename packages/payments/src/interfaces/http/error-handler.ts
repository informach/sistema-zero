...
const DOMAIN_STATUS: Record<string, number> = {
  ...
  BOLETO_DATA_INCOMPLETE: 422,
  CARD_DATA_INCOMPLETE: 422,
  SUBSCRIPTION_NOT_FOUND: 404,
  SUBSCRIPTION_DATA_INCOMPLETE: 422,
}

/**
 * Traduz qualquer erro (domínio, gateway, validação da borda, inesperado) em um
