 ...
 * só no topo NUNCA casa (a corrida de unicidade de slug virava 500 em vez de 409).
 * Caminha a cadeia de `cause` (com teto). Mesmo padrão de auth/members/catalog.
 */
 ...
 * admin sejam LITERAIS — "100%" não vira padrão (wildcard injection no ILIKE).
 */
