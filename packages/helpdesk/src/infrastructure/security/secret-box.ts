...
/**
 * Cofre de segredos AES-256-GCM para os tokens do Gmail.
 *
 ...
 * outra tabela/serviço (ex.: marketing.social_account) não abre aqui.
 *
 * Cópia do padrão do marketing com AAD própria; promover ao core quando um
 * terceiro serviço precisar.
 */
const VERSION = 'v1'
const AAD = Buffer.from('helpdesk.gmail_connection')
const IV_BYTES = 12
...
/** Cria o cofre a partir da chave (32 bytes em base64 — `HELPDESK_TOKEN_ENC_KEY`). */
