...
criança + `play_id` do link público de jogar). 4 segmentos — `/hub/internal/...` não colide com as rotas do
aluno nem com `/hub/admin/*`; o hub re-valida elegibilidade (S2S members) + autoria (header de perfil).
