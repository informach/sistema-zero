...
/** ISO UTC → chave do dia civil em SP (`YYYY-MM-DD`) — agrupamentos por dia. */
...
/** ISO curto amigável em SP (dd/mm HH:mm) p/ chips e linhas das listas. */
...
/** Só a hora em SP (HH:mm) p/ chips compactos. */
