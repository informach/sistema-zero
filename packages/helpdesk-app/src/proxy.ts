 ...
 *     `/tickets`, `/base-conhecimento`, …) sem cookie de sessão (a checagem REAL
 *     de assinatura/role acontece no layout do grupo via `getSession`).
 *
...
const APP_PREFIXES = ['/tickets', '/base-conhecimento', '/configuracoes']
...
export const config = {
  ...
  // favicon ficam fora (mesmo matcher do marketing-app — aqui também não há
  // upload passando pelo BFF).
