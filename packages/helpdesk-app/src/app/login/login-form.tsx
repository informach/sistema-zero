...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  FORBIDDEN: 'Esta conta não tem acesso ao helpdesk.',
...
export function LoginForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        // `?next=` preservado pelo proxy (deep-link no app); validado anti
  ...
  return (
    <Card className="w-full max-w-sm">
      <CardHeader>
        ...
        <CardTitle className="sr-only">Sistema Zero — Helpdesk</CardTitle>
        <CardDescription className="text-center">
          Helpdesk. Entre com sua conta da equipe.
        </CardDescription>
      </CardHeader>
      <CardContent>
