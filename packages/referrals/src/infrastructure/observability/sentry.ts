 ...
 * Espelha o padrão do payments/auth/members/fiscal.
 */
 ...
 * evento. A convenção do monorepo é "log ERROR = sinal alertável" — com o
 * espelho, esses sinais geram issue/alerta sem tocar nenhum call site.
