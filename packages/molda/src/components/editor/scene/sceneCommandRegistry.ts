...
const COMMAND_DEFINITIONS = [
  ...
  // ── aba Pintar: as ferramentas e os atalhos do editor antigo ────────────────
  {
    id: 'paint.pencil',
    label: scene.paintPencil,
    icon: Pencil,
    contexts: paint,
    slot: 'rail',
    tier: 1,
  ...
  },
  {
    ...
    toggle: true,
    shortcut: key('M', 'm'),
    help: SCENE_PAINT_COPY.mirrorHint,
  },
  {
    id: 'paint.dress',
  ...
  {
    id: 'paint.width-1',
    label: SCENE_PAINT_COPY.width[1],
    icon: Paintbrush,
    contexts: paint,
    slot: 'rail-options',
    tier: 1,
  ...
  {
    id: 'paint.width-2',
    label: SCENE_PAINT_COPY.width[2],
    icon: Paintbrush,
    contexts: paint,
    slot: 'rail-options',
    tier: 1,
  ...
  {
    id: 'paint.width-3',
    label: SCENE_PAINT_COPY.width[3],
    icon: Paintbrush,
    contexts: paint,
    slot: 'rail-options',
    tier: 1,
