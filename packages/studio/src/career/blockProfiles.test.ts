...
describe('perfil Jogo 2D Essencial', () => {
  test('contém os 61 tipos da referência (com o Kit espaço COMPLETO), sem duplicatas', () => {
    ...
    // 58 → 60 em 15/09: "Definir o tamanho do sprite" e "Multiplicar o tamanho do
    // sprite" entram pelo MESMO motivo do bloco acima. Quem monta uma placa com o
    // fundo de imagem precisa dizer de que tamanho ela é, e os dois estavam um
    // degrau acima dos blocos de texto que eles completam.
