 ...
 *
 * Helper idêntico no Pinta (`packages/pinta/src/core/perf.ts`) e no host kids
 * (`community-kids/src/lib/perf.ts`): copiar em vez de compartilhar mantém os pacotes sem
