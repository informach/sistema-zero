 ...
 * de painel, sombra dura; pressionado = borda e tinta suaves do acento via `[aria-pressed]`),
 * a mesma do Pinta e do Pensa. Sem `title`: com `aria-label` ele viraria descrição e o leitor
 * repetiria. Mora aqui (e não em `studio/host-chrome.ts`) porque aquele é o contrato de DADOS
 * que o kids consome; este é o desenho, que vive com a Topbar e a lista.
 */
