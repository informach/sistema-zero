...
describe('descoberta dos exemplos do Jogo 2D', () => {
  it('todos os 31 exemplos têm dificuldade, gênero e conceitos pesquisáveis', () => {
    expect(gameTwoDExamples).toHaveLength(31)
  ...
  it('o loader validado entrega os metadados à galeria', async () => {
    ...
    expect(gameTwoDGroup?.entries).toHaveLength(31)
