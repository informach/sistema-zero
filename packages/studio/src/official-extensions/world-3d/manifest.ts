...
os sites-mundo dos grandes estúdios. Ela usa \`window.SZWorld3D\`. Diferente dos
...
- **Grama ao vento: pouca/média/muita**. O toque de vida: milhares de
  ...
  com o carrinho (parece infinita). Custa UM desenho para a placa de vídeo. A mesma mágica dos sites profissionais.
...
- Coloque "Criar o mundo 3D" em **⚙️ Ao iniciar**. O Estúdio começa o passeio
  automaticamente depois de registrar **⚡ Quando acontecer** e
