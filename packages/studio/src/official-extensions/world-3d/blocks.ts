...
export const world3DBlocks = [
  ...
  },
  {
    ...
    colour: C,
    tooltip:
      'Moedas douradas girando pelo mundo (nunca embaixo d’água). Encoste para pegar: plim, contador no canto e o "Quando pegar uma moeda" dispara.',
  },
  {
    ...
    nextStatement: 'JSStmt',
    colour: C,
    tooltip: 'Um círculo de moedas ao redor de um lugar especial (o farol, a praça…).',
  },
  {
  ...
  },
  {
    ...
    message0: 'quantas moedas pegou',
    args0: [],
    output: 'JSValue',
    colour: C,
    tooltip: 'O total de moedas pegas até agora. Use num "se" para criar metas.',
  },
  {
    type: 'sz_w3d_quest',
    ...
    args0: [
      ...
      { type: 'field_input', name: 'DESC', text: 'Pegue 15 moedas' },
    ],
    inputsInline: true,
    previousStatement: 'JSStmt',
    nextStatement: 'JSStmt',
    colour: C,
    tooltip:
      'Uma missão com nome e descrição. A missão ATIVA (a primeira não completa) aparece sozinha no canto da tela.',
  },
  {
    ...
    colour: C,
    tooltip:
      'Marca a missão como completa: confete, fanfarra, o painel troca para a próxima e o "Quando completar" dispara.',
  },
  {
    ...
    nextStatement: 'JSStmt',
    colour: C,
    tooltip: 'A recompensa: fogos, uma fala do amigo, a chave do próximo lugar…',
  },
  {
    type: 'sz_w3d_marker',
...
export const W3D_SOCKET_SHADOWS: Record<string, Record<string, unknown>> = {
  ...
  sz_w3d_coins_scatter: { N: numShadow(20) },
  sz_w3d_coins_ring: { N: numShadow(8), X: numShadow(0), Z: numShadow(20), R: numShadow(6) },
  sz_w3d_coins_line: {
    N: numShadow(10),
    X1: numShadow(0),
    Z1: numShadow(10),
