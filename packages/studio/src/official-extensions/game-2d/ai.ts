...
- setSpriteText(sprite, textoOuNumero), spriteText(sprite): mudar/ler apresentação; a troca conserva identidade, posição, velocidade, dados e grupos. setTextStyle(sprite, tamanho, cor) usa a fonte do jogo. setTextBox(sprite, largura, alinhamento, margem, fundo): largura 0 automática, outra largura quebra linhas; alinhamento left/center/right; fundo "transparent", cor CSS ou rgba com alfa 0 (nada pintado). setTextImage(sprite, imagem, top|middle|bottom): põe uma imagem do projeto como fundo do sprite de texto; a imagem MANDA no tamanho (sem deformar), o texto quebra na largura dela menos a margem e o terceiro argumento diz a altura do texto. Imagem vazia volta ao fundo de cor; exige um sprite que já seja de texto. Texto até 4096 caracteres, fonte até 512px.
