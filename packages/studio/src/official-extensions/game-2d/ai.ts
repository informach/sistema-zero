...
- useFont(id): escolhe a letra de TODO texto do jogo (placar, telas, mensagens). Os cinco ids são baloo2, nunito, pressStart2P, bungee e fredoka. Vale para o jogo INTEIRO e a escolha é resolvida ANTES de o jogo rodar (só a fonte escolhida é embutida no documento), então o bloco vai em "Ao iniciar", uma vez só, com o nome escrito à mão — dentro de um "se" ou guardado numa variável ele não muda nada e o runtime avisa. Bloco "Usar a fonte". ⚠️ Não alcança o drawPixelText/drawPixelScore, que são letras desenhadas ponto a ponto.
