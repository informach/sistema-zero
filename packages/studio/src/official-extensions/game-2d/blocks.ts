...
const SUBCATS: { name: string; colour: string; types: string[] }[] = [
  ...
  },
  {
    ...
    types: [
      ...
      'sz_g2d_stickhero_scenery',
      'sz_g2d_stickhero_hold',
      'sz_g2d_stickhero_step',
      'sz_g2d_stickhero_draw',
      ...
      // Legados ocultos (abrem projetos salvos; a cor do grupo ainda vale p/ eles).
  ...
  },
  {
    ...
    types: [
      ...
      'sz_g2d_balloon_scenery',
      'sz_g2d_balloon_lift',
      'sz_g2d_balloon_scroll',
      'sz_g2d_balloon_draw',
...
const G2D_SOCKET_SHADOWS: Record<string, Record<string, unknown>> = {
  ...
  sz_g2d_stickhero_hold: { SPEED: numShadow(1) },
  sz_g2d_stickhero_step: { SPEED: numShadow(1) },
  sz_g2d_balloon_lift: { FORCE: numShadow(1) },
  sz_g2d_balloon_scroll: { SPEED: numShadow(1) },
