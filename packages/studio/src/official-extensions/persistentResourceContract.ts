...
export const GAME_KIT_PERSISTENT_COMMANDS = [
  ...
  { blockType: 'sz_gk_rpg_give_potion', statementType: 'gk:rpgGivePotion' },
  { blockType: 'sz_gk_rpg_add_foe', statementType: 'gk:rpgAddFoe' },
  { blockType: 'sz_gk_rpg_add_boss', statementType: 'gk:rpgAddBoss' },
  { blockType: 'sz_gk_rpg_add_foe_named', statementType: 'gk:rpgAddFoeNamed' },
...
export const GAME_3D_PERSISTENT_COMMANDS = [
  { blockType: 'sz_g3d_play_music', statementType: 'g3d:playMusic' },
] as const
