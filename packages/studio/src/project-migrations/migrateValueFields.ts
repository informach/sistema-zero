...
export const LEGACY_VALUE_FIELDS: Record<string, Record<string, 'number' | 'text' | 'color'>> = {
  ...
  sz_g2d_fly_free: { SPEED: 'number' },
  sz_g2d_flap: { FORCE: 'number' },
  ...
  sz_g2d_classic_platformer: { SPEED: 'number', JUMP: 'number' },
  sz_g2d_platformer: { SPEED: 'number', JUMP: 'number' },
  sz_g2d_platformer_terrain: { SPEED: 'number', JUMP: 'number' },
  sz_g2d_jump_terrain: { JUMP: 'number' },
  ...
  sz_g2d_stickhero_sprite: { W: 'number', H: 'number' },
  sz_g2d_stickpath_grow: { SPEED: 'number' },
  sz_g2d_stickpath_walk: { SPEED: 'number' },
  sz_g2d_balloon_sprite: { X: 'number', Y: 'number', W: 'number', H: 'number' },
  sz_g2d_balloon_fire: { FORCE: 'number' },
  sz_g2d_balloonpath_scroll: { SPEED: 'number' },
  ...
  sz_g2d_draw_label: { TEXT: 'text', X: 'number', Y: 'number', SIZE: 'number' },
  sz_g2d_create_text_sprite: { TEXT: 'text', X: 'number', Y: 'number' },
  sz_g2d_spawn_text_in_group: { TEXT: 'number', X: 'number', Y: 'number' },
  sz_g2d_set_sprite_text: { TEXT: 'text' },
  sz_g2d_set_text_style: { SIZE: 'number' },
  sz_g2d_set_text_box: { WIDTH: 'number', PADDING: 'number', BACKGROUND: 'text' },
  sz_g2d_set_sprite_data: { VALUE: 'number' },
  sz_g2d_sprite_data: { FALLBACK: 'number' },
  ...
  sz_g2d_set_volume: { LEVEL: 'number' },
  ...
  sz_g2d_campaign_value: { FALLBACK: 'number' },
  sz_g2d_define_vector_tile: { INDEX: 'number' },
  sz_g2d_set_tile_at_contact: { INDEX: 'number' },
  sz_g2d_create_tilemap: { TILE: 'number' },
  sz_g2d_draw_tilemap: { X: 'number', Y: 'number', SIZE: 'number' },
  sz_g2d_place_tilemap: { X: 'number', Y: 'number', SIZE: 'number' },
  sz_g2d_create_world: { W: 'number', H: 'number' },
  sz_g2d_create_world_from_tilemap: { SIZE: 'number' },
  sz_g2d_world_camera: { DEAD_X: 'number', DEAD_Y: 'number' },
  sz_g2d_create_level: { X: 'number', Y: 'number' },
  ...
  sz_g2d_spawn_bullet: { X: 'number', Y: 'number', R: 'number', VX: 'number', VY: 'number' },
  sz_g2d_spawn_asteroid: { X: 'number', Y: 'number', SIZE: 'number', VX: 'number', VY: 'number' },
  ...
  sz_g2d_after_seconds: { SECS: 'number' },
  ...
  sz_g3d_set_rotation: { X: 'number', Y: 'number', Z: 'number' },
  sz_g3d_set_scale: { FACTOR: 'number' },
  ...
  sz_g3d_set_velocity: { X: 'number', Y: 'number', Z: 'number' },
  sz_g3d_jump: { FORCE: 'number' },
  sz_g3d_grid_position: { ROW: 'number', COL: 'number' },
  ...
  sz_g3d_move_by: { X: 'number', Y: 'number', Z: 'number' },
  sz_g3d_rotate_by: { AMOUNT: 'number' },
  sz_g3d_look_at_point: { X: 'number', Y: 'number', Z: 'number' },
  sz_g3d_move_forward: { DIST: 'number' },
  sz_g3d_body: { GRAVITY: 'number' },
  sz_g3d_platformer_controls: { SPEED: 'number', JUMP: 'number' },
  sz_g3d_classic_platformer: { SPEED: 'number', JUMP: 'number' },
  sz_g3d_set_object_value: { VALUE: 'number' },
  sz_g3d_stage_number: { WORLDN: 'number', STAGEN: 'number' },
  sz_g3d_load_stage: { MAP: 'text' },
  ...
  sz_g3d_spawn_enemy: { SPEED: 'number' },
  sz_g3d_every_frames: { N: 'number' },
  sz_g3d_every_seconds: { SECS: 'number' },
  ...
  // 🌍 Mundo aberto
  sz_gk_rpg_create_map: { COLS: 'number', ROWS: 'number' },
  ...
  sz_gk_rpg_add_boss: { HP: 'number', STR: 'number', DEF: 'number' },
  sz_gk_rpg_define_battler: { HP: 'number', STR: 'number', DEF: 'number' },
  sz_gk_rpg_foe_hit_all: { DMG: 'number' },
  sz_gk_rpg_teach_move: { DMG: 'number', COST: 'number' },
  sz_gk_rpg_teach_heal: { AMOUNT: 'number', COST: 'number' },
  sz_gk_roll_dice: { FACES: 'number' },
  sz_gk_players_setup: { N: 'number' },
  sz_gk_move_along_track: { SPACES: 'number' },
  sz_gk_card: { FRONT: 'text', BACK: 'text' },
  sz_gk_card_flip: { CARD: 'number' },
  sz_gk_card_is_up: { CARD: 'number' },
  sz_gk_card_face: { CARD: 'number' },
  sz_gk_hand_draw: { X: 'number', Y: 'number' },
  sz_gk_card_at: { X: 'number', Y: 'number' },
  sz_gk_cards_start: { HERO_HP: 'number', ENEMY_HP: 'number' },
  sz_gk_cards_energy_per_turn: { N: 'number' },
  sz_gk_cards_spend: { N: 'number' },
  sz_gk_cards_hurt_enemy: { N: 'number' },
  sz_gk_cards_hurt_me: { N: 'number' },
  sz_gk_cards_gain_block: { N: 'number' },
  sz_gk_cards_enemy_intent: { VALUE: 'number' },
  sz_gk_board_create: { COLS: 'number', ROWS: 'number', EMPTY: 'number' },
  sz_gk_board_set: { VALUE: 'number', COL: 'number', ROW: 'number' },
  sz_gk_board_get: { COL: 'number', ROW: 'number' },
  sz_gk_board_count: { VALUE: 'number' },
  sz_gk_board_in: { COL: 'number', ROW: 'number' },
  ...
  sz_gk_set_hitbox_shape: { RADIUS: 'number' },
  ...
  sz_t3d_debug_grid: { SIZE: 'number', DIV: 'number' },
  sz_t3d_debug_axes: { SIZE: 'number' },
  ...
  sz_w3d_tornado: { SECS: 'number' },
  sz_w3d_push_place: { X: 'number', Z: 'number' },
  sz_w3d_push_scatter: { N: 'number', X: 'number', Z: 'number', R: 'number' },
  sz_w3d_letters: { X: 'number', Z: 'number', S: 'number' },
  sz_w3d_explosive: { X: 'number', Z: 'number' },
  sz_w3d_waterfall: { X: 'number', Z: 'number', H: 'number', DEG: 'number' },
  ...
  sz_w3d_coins_scatter: { N: 'number' },
  sz_w3d_coins_ring: { N: 'number', X: 'number', Z: 'number', R: 'number' },
  ...
  sz_w3d_district: { X: 'number', Z: 'number', SIZE: 'number' },
  sz_w3d_road_grid: { X: 'number', Z: 'number', SIZE: 'number', WIDTH: 'number' },
  sz_w3d_house_row: {
    N: 'number',
    X1: 'number',
    Z1: 'number',
  ...
  sz_w3d_inventory_give: { N: 'number' },
  sz_w3d_inventory_remove: { N: 'number' },
  sz_w3d_inventory_has: { N: 'number' },
  sz_w3d_traffic: { N: 'number' },
  sz_w3d_door: { X: 'number', Z: 'number', DEG: 'number' },
  sz_w3d_crops: { N: 'number', X: 'number', Z: 'number' },
  sz_w3d_barn: { X: 'number', Z: 'number', DEG: 'number' },
  sz_w3d_windmill: { X: 'number', Z: 'number' },
  sz_w3d_fence: { X1: 'number', Z1: 'number', X2: 'number', Z2: 'number' },
  sz_w3d_animals: { N: 'number', X: 'number', Z: 'number', R: 'number' },
  sz_w3d_crater: { X: 'number', Z: 'number', R: 'number' },
  sz_w3d_flag: { X: 'number', Z: 'number' },
  sz_w3d_rocket: { X: 'number', Z: 'number' },
