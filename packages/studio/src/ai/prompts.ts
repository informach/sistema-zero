...
- ${BEHAVIOR_AREA_LABELS.molds}: guarda só o que DEFINE e não faz nada sozinho (classe, função, figura desenhada por código, tipo de inimigo e seus ajustes). Roda antes de tudo. Dá para criar vários moldes e não usar nenhum.
- ${BEHAVIOR_AREA_LABELS.start}: prepara o projeto uma vez quando ele abre ou reinicia, USANDO os moldes. Carregar arquivos prontos (som, imagem ou folha de quadros) pertence aqui.
