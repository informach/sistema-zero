...
describe('contrato transversal dos 93 exemplos da KitGallery', () => {
  it('catálogo e contratos têm exatamente as mesmas chaves', () => {
    ...
    expect(catalogKeys).toHaveLength(93)
    expect(new Set(catalogKeys).size).toBe(93)
  })
  ...
  it('mantém a classificação acordada: 72 jogos, 9 demos e 12 explorações', () => {
    ...
    expect(counts).toEqual({ game: 72, demo: 9, exploration: 12 })
  })
