 ...
 * frame (🧱 Estrutura / 🎨 Aparência / ⚙️ Comportamento). Vários testes de unidade
...
export function irInFrame(ws: Blockly.Workspace, kind: keyof typeof FRAME_FOR = 'js'): SZIR {
