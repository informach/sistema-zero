...
A paleta permanece extensa por decisão de produto: são 284 definições de bloco
(284 visíveis e 0 ocultas). A seleção do conteúdo apresentado continua
...
manifesto vigente está em **1.1.0** após os fechamentos subsequentes: grupos
...
- 284 definições de blocos e 14 famílias com subseções;
- 292 métodos e valores públicos em `window.SZGame2D`;
