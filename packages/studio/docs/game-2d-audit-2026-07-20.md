...
(283 visíveis e 0 ocultas). A seleção do conteúdo apresentado continua
...
manifesto vigente está em **1.0.0** após os fechamentos subsequentes: grupos
...
- 168 arquivos próprios da extensão;
- 283 definições de blocos e 14 famílias com subseções;
- 291 métodos e valores públicos em `window.SZGame2D`;
