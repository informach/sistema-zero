 ...
 * `@rive-app/canvas` deixando de ser resolvível daqui. Aí o script falha, o WASM não
 * é servido, e a prévia da animação fica em branco sem que nada acuse.
 *
 * ⚠️ Gêmeo do teste do `community-kids`: os dois pacotes resolvem o binário da
 * PRÓPRIA versão instalada, e as versões precisam andar juntas (é o runtime do kids
 * que abre, de verdade, o arquivo que este painel valida e publica).
 */
