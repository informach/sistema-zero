 ...
 * dos cookies de sessão. No domínio definitivo o painel divide o eTLD+1 com
 * funil/community/cdn: um subdomínio irmão comprometido dispara requisições
 * **same-site** que LEVAM os cookies do admin (`Lax` não barra same-site). Por
 * isso TODA mutação precisa ser **same-origin**:
 *
