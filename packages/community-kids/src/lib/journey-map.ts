...
/**
 * Regras PURAS do Mapa da Jornada (/cursos): que trilha cada nível estuda, quais
 * cursos essa trilha MOSTRA, o estado de cada nó e quando uma trilha está bloqueada.
 * A APRESENTAÇÃO vive em `components/kids/journey-map.tsx`; a régua real de acesso é
 ...
 * cursos bônus. Espelha a escada do core (`CREATOR_JOURNEY_LEVELS`): os slots são
