...
/**
 * Pensa: NÃO consegui verificar o acesso agora (gateway/token soluçou —
 * `checkPensaAccessReadonly` devolveu status ≠ 200). É DISTINTO do bloqueio real
 * (`KidsLockedPensa`, "peça a um responsável"): mostrar "ainda não liberado" a quem
 ...
 */
export function KidsPensaUnavailable() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center px-4 py-12 text-center">
      ...
      <p className="mt-4 text-muted-foreground">
        Não consegui verificar agora se o Pensa está liberado pra você. Pode ter sido um tropeço na
