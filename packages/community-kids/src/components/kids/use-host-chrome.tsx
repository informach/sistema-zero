 ...
 * o selo da nuvem (da fila de `creations-cloud`), a seta das galerias de volta à seção-mãe
 * (do `backToSection` do menu) e o sinal de que a nuvem da conta está ligada.
 * Tudo memoizado: o valor só troca
 * quando algo VISÍVEL muda, senão cada autosave re-renderizaria a barra da ferramenta.
 * O controle do menu lateral pertence ao shell Kids e nunca é duplicado aqui.
 *
