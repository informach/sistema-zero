...
/**
 * Estúdio Completo: NÃO consegui verificar o acesso agora (gateway/token soluçou —
 ...
 * JÁ comprou, num erro transitório, mentiria que ela não tem o produto. Aqui o recado
 * é "tente de novo" + um botão que re-renderiza a página (re-checa o acesso no servidor).
 */
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center px-4 py-12 text-center">
      ...
      <p className="mt-4 text-muted-foreground">
        Não consegui verificar agora se o Estúdio está liberado pra você. Pode ter sido um tropeço
        na conexão. Tenta de novo? 😊
      </p>
      <button
        type="button"
