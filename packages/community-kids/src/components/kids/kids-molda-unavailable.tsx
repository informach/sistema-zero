...
export function KidsMoldaUnavailable() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-md flex-col items-center px-4 py-12 text-center">
      ...
      <h1 className="mt-4 [font-family:var(--font-display)] font-bold text-2xl">Molda</h1>
      <p className="mt-4 text-muted-foreground">
        Não consegui verificar agora se o Molda está liberado pra você. Pode ter sido um tropeço na
