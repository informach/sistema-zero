...
import { JourneyHorizonNode } from '../src/components/kids/journey-horizon-node'
...
function renderNode(levels: Parameters<typeof JourneyHorizonNode>[0]['levels']) {
  return render(<JourneyHorizonNode point={point} viewHeight={400} levels={levels} />)
}

describe('JourneyHorizonNode', () => {
