...
**Tipo:** application. **Objetivo:** Colocar Ao iniciar no projeto e entender que esta área prepara a partida.

**Reaproveitamento:** Parte 1. Passo 1: montar a área que prepara o jogo.

**Montagem / imagem:** Preservar o gesto completo, a área vazia e a analogia do tabuleiro. Não acrescentar outra demonstração.

**Fala original selecionada, antes dos cortes acima:** Antes de tudo, o seu jogo precisa de um lugar pra ser montado. Lá na coluna da esquerda, onde ficam os bloquinhos, vai na categoria Áreas do projeto. Dentro dela tem o bloco Ao iniciar. Clica nele, segura, arrasta até essa área grande do meio e solta. Esse bloco é uma área, que é um espaço que segura outros blocos dentro dele. E tudo que você colocar aí dentro acontece uma vez só, quando o jogo liga. Por isso o nome, ao iniciar. É tipo montar um jogo de tabuleiro: você abre o tabuleiro, separa as peças, dá as cartas. Uma vez só, no começo. Depois é só jogar. E é dentro dessa área que vão os três próximos passos de hoje. Primeiro passo pronto. O segundo é preparar a tela.

**Orientação ao aluno:** “Em Áreas do projeto, coloque Ao iniciar no espaço de montar. Nesta etapa ele fica vazio. Confira seu projeto para continuar.”
...
**Montagem / imagem:** Reaproveitar recapitulacão e gancho da Aula 2. Acrescentar somente uma cartela curta indicando o quiz. Não dizer que o aluno já programou o desenho do Dino.
