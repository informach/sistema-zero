...
Você terminou o Desafio do Primeiro Jogo e publicou no Mural. O Pinta e o Estúdio Completo estão disponíveis conforme sua Carreira e o acesso da conta.

**Resultado:** Levar o projeto do Dia 5 ao Estúdio Completo e reconhecer onde cada versão fica guardada.
...
**"Trilha Faísca"**, achar o cartão do **Desafio do Primeiro Jogo** e clicar em **"Acessar curso"**.
Na lista de aulas, achar a do **Dia 5** e abrir. ⚠️ **Quem grava precisa saber, e a fala não diz:**
a do Dia 5 **não é a última da lista** (depois dela vêm o certificado e a de encerramento), então
não vale pegar a última por atalho na hora de gravar.
Com a aula aberta e o jogo à vista, **abrir o menu de três pontinhos do estúdio da aula**, apontar a
parte **Arquivo** e dar um close no **"Sincronizar com o enviado"** enquanto a narração fala dele,
**sem clicar** (o jogo já está certo na gravação). Fechar o menu antes de seguir.
Rolar até o estúdio da aula, com o jogo da nave montado e rodando. Abrir o menu de três pontinhos,
apontar o título **Arquivo** e clicar em "Exportar para o Estúdio". Mostrar o arquivo baixando, com o
nome completo à vista. Voltar ao menu da esquerda, clicar em **Estúdio**, clicar em "Importar" e
**dar dois cliques no arquivo** dentro da janela do computador. O
projeto abre sozinho. Mostrar o jogo da nave rodando, clicar na área do jogo e mover a nave com as setas.
Apontar a coluna da esquerda com a categoria Jogo 2D já presente.
Depois, **zoom no nome do projeto** na barra de cima, mostrando o **"Projeto da aula"**, clicar nele
para virar campo, apagar, digitar **"Nave contra asteroides"** e apertar Enter. Cortar rápido para o
cartão dele no Meus Jogos, já com o nome novo, e voltar.
Fechar o passo com o **puxador do menu**: enquadrar a tela cheia, dar **zoom no puxador colado na
borda esquerda**, clicar, mostrar o menu da Comunidade sumindo e a área de trabalho crescendo, e
...
e apontar os dois cartões.
Depois, ilustrar com três cenas curtas: a mesma tela num navegador diferente, com a lista vazia; a
aula do Dia 5 do Desafio, com o jogo lá; e o cartão do jogo dela no Mural. Na cena da aula do
Desafio, abrir o menu de três pontinhos e dar um close em **"Sincronizar com o enviado"**, sem
