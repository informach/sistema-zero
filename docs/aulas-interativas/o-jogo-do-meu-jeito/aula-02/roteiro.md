...
Seu jogo está no Estúdio Completo. A nave ainda é a do Kit espaço, e você vai criar a sua própria arte.

**Resultado:** Criar um personagem em pixel art de 32 × 32, explorando forma, cor, luz e sombra com autonomia.
...
**"Criar novo"**. Clicar em **"Criar novo"** e percorrer o assistente. No passo 1, com os cartões
**👾 Pixel art** e **✏️ Vetor** já à vista, dar zoom nos dois e ler as descrições enquanto a
explicação dos estilos acontece, cortando para um trecho do **Celeste** (o jogo em pixel art, a cena
de conversa em vetor), e só então escolher **Pixel art**. No passo 2, escolher **🧍 Personagem**. No
passo 3, mostrar que o **Pequeno** vem marcado e clicar em **Médio**, com zoom no detalhe "32 × 32".
...
uma: o corpo da primeira, a asa da segunda. Quando o contorno ficar pronto, voltar às duas por três
segundos, com a nave dele no meio, para ficar visível que ela não é cópia de nenhuma. Escolher o
**preto** na paleta,
com zoom mostrando que ele é a última cor, sozinha na linha de baixo. Ligar o
**"Espelho lado a lado"** na caixa de ferramentas, com zoom no botão aceso. Pegar a
**Linha**, traçar a lateral do corpo e mostrar a linha nascendo espelhada do outro lado ao mesmo
tempo. Desfazer com **Ctrl+Z** uma vez e refazer o traço num ângulo melhor, mostrando que se
...
comparativo curto ao lado: a mesma nave numa cor escura demais, onde a sombra não teria pra onde ir. Pegar o **Balde de
tinta** e encher o corpo e as asas da nave dele. Quando um clique encher só um lado, dar zoom nisso
e clicar no outro. Trocar para o **azul** e encher a cabine, com zoom no contraste contra o lilás.
Pegar o **Lápis** e pôr os detalhes em **verde** na asa e na ponta. Enquadrar a nave inteira quando a
narração falar da proporção, para ficar visível que a cor base ocupa a maior parte e as outras duas
entram só em pedacinhos.
...
do passo**. **A ordem é por etapa, não por parte da nave:** primeiro a **sombra**, que na nave do
Júlio é **só no corpo** (roxo escuro `#5c406c`), porque a cabine e os detalhes já saíram do passo 3
em tons escuros; depois as **três luzes**, na ordem corpo, cabine e detalhes (rosa claro `#e5cdc4`,
azul claro, verde claro). Cada troca de cor é um clique na paleta, à vista. Dar zoom na cabine
ganhando volume com o azul claro. Quando a
narração falar das vizinhas, **dar zoom na paleta** duas vezes: nas três do corpo, acesas em
sequência na mesma linha, e depois nos azuis, também vizinhos entre si. Na conferência final,
**percorrer a nave inteira devagar**, parar num pedaço que ficou sem sombra e corrigir ali mesmo.
Comparar, com um corte rápido, a nave dele de antes e a de agora. Terminar com duas versões da mesma
...
que a fala destaca. ⚠️ **Os dois não ficam lado a lado**, são de barras diferentes: o Salvo é do
Pinta e o Guardado na sua conta é da Comunidade, por cima dele. Ilustrar a volta em outro computador com uma
cena curta: a mesma galeria, com a `nave` lá, num computador diferente. No fim, **dar zoom na
