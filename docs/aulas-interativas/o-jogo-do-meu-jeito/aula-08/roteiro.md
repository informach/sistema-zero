...
Seu jogo livre já tem nave e asteroides desenhados por você e foi testado do começo ao fim.

**Resultado:** Publicar a criação, escolher uma mudança própria e repetir um processo de criar, testar e compartilhar.
...
solto, fora do menu de três pontinhos. Clicar. Mostrar a modal **"Compartilhar no Mural dos
Criadores"** inteira: o campo "Título", o campo "Resumo do projeto" com o botão de escrever com
ajuda, a "Capa do projeto" com "Gerar capa" e "Enviar uma imagem", o quadro do "🏆 Participar do
Desafio do mês" com o tema do mês no rótulo, o aviso amarelo de que a versão publicada fica salva do
jeito que está, e os botões "Cancelar" e "Publicar". Preencher tudo devagar e clicar em "Gerar capa",
mostrando a capa aparecendo. Ao chegar no Desafio do mês, **zoom no quadradinho** e depois três
cortes curtos: (1) a página inicial da Comunidade com o cartão do troféu, mostrando o emoji, o
título e a descrição do tema; (2) o Mural com a prateleira do desafio no topo, com o troféu e o nome
do tema no título dela; (3) o Clube dos Criadores com um anúncio de destaques do mês. Voltar para a
modal com o quadradinho **ainda em branco**. Clicar em "Publicar". Mostrar a tela "Publicado! 🎉"
com "Ver no Mural", "Abrir o jogo" e "Copiar link". **Clicar no "Fechar" do rodapé** (o "Ver no
...
que os blocos são os mesmos do jogo dela. Depois a versão do submarino desviando de águas-vivas, e a
de um passarinho desviando de galhos. Em seguida, duas telas lado a lado com o mesmo jogo da nave, uma
...
criado na Aula 1. Mostrar a área do jogo vazia e a coluna da esquerda com a categoria Jogo 2D
presente, porque a extensão já foi instalada naquela aula. **Nenhum bloco é apontado aqui.**
Depois ir ao **Mural** pelo menu da esquerda, rolar pelos cartões de outras crianças,
**jogar um deles por alguns segundos** e voltar ao cartão. Dar zoom no botão **"Fazer a minha
