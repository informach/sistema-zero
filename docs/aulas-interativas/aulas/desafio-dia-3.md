...
gravação, não arquivos de mídia já publicados. O [roteiro](desafio-dia-3.roteiro.md) detalha
...
conferência do projeto salvo. Introdução e certificado permanecem fora deste padrão.
