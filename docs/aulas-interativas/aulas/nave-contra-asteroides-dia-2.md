# Nave Contra Asteroides · Dia 2 · A nave atira
...
O [roteiro de gravação](nave-contra-asteroides-dia-2.roteiro.md) traz fala e ação de tela de cada clipe.
...
O Dia 2 não altera o projeto de entrada do Dia 1. A introdução e o certificado pertencem ao
Desafio do Primeiro Jogo e ficam fora deste curso. Os campos x/y do
