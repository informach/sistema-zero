...
Revisão posterior: [achados, correções e nova rodada de verificação](revisao-completa-v5-2026-09-12.md). Os resultados abaixo registram a conferência original da entrega.
